...
\node [draw] (v7) at (.5,10.5) {\gls{ta} 2};
\node [draw] (v7) at (4.5,10.5) {\gls{ta} 3};
\node [draw] (v6) at (-3.5,8) {TEE Core \textcolor{ForestGreen}\faKey};
\node [draw] (v5) at (4.5,8) {TEE Libs};
\node [draw] (v3) at (-3.5,6) {\gls{tfa} Secure Monitor \textcolor{ForestGreen}\faKey};
...
\node [small, minimum height=0] (v9) at (-3.5,4) {EL3 Exception};
